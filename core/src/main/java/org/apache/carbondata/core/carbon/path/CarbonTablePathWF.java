 ...
 */
public class CarbonTablePathWF extends Path {
     ...
     */
    public CarbonTablePathWF(String tablePathString) {
    ...
    @Override public boolean equals(Object o) {
        if (!(o instanceof CarbonTablePathWF)) {
            return false;
        }
        CarbonTablePathWF path = (CarbonTablePathWF) o;
